...
void test()
{
  ...
  try
  {
    ...
    addr1 = ip::make_address_v4("REMOVED_SECRET");
    addr1 = ip::make_address_v4("REMOVED_SECRET", ec);
    addr1 = ip::make_address_v4(string_value);
    addr1 = ip::make_address_v4(string_value, ec);
#if defined(ASIO_HAS_STRING_VIEW)
# if defined(ASIO_HAS_STD_STRING_VIEW)
    std::string_view string_view_value("REMOVED_SECRET");
# elif defined(ASIO_HAS_STD_EXPERIMENTAL_STRING_VIEW)
    std::experimental::string_view string_view_value("REMOVED_SECRET");
